...
def PartitionROM(input_json : str, limb_len : float = 1.6):
    ...
    mesh_info.save_to_json(f'FM_FEM/fmfem/ReducedOrder/input_json/{input_json}_straight')
    ...
    for dict in data["Mesh Sections"]:
        if dict["type"] == "Bend":
            ...
            mesh_info.save_to_json(f'FM_FEM/fmfem/ReducedOrder/input_json/{input_json}_bend{bend_count}')
